...
**The research infrastructure gap:** Public economics increasingly requires modeling the joint tax-benefit system—how income taxes interact with SNAP, Medicaid, and EITC to shape household incentives. Yet existing infrastructure was built for an earlier era: TAXSIM (1,000+ citations) models taxes but not benefits; TRIM3 models benefits but is only accessible through commissioned reports from Urban Institute. Neither supports independent reform modeling. Researchers studying effective marginal tax rates, benefit cliffs, or optimal policy design must cobble together separate tools.
