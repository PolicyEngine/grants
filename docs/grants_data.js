  ...
  "gitlab": {
    ...
    "responses": {
      ...
      "project_title_summary": {
        ...
        "plainText": "Project Title:\nAI-Powered Rules-as-Code Infrastructure: Automating Benefit Policy from Documents to Calculations\n\nProject Summary (150 words):\n\nBenefit navigation tools like MyFriendBen, Starlight, and Amplifi help millions access government assistance\u2014but they're constrained by rules-as-code coverage. Human experts manually encode 50 states \u00d7 80+ benefit programs from scattered policy documents. It's slow, expensive, and incomplete, creating gaps where tools can't help people access benefits they qualify for.\n\nPolicyEngine will build a complete AI pipeline transforming benefit policy from source documents to accurate calculations. LLMs extract rules from legislative PDFs and policy manuals. AI generates PolicyEngine code and validates against authoritative sources. Machine learning models handle missing household data through stochastic imputation, predicting benefit ranges when information is incomplete. LLMs explain calculations in plain language for consumer tools.\n\nThis infrastructure enables benefit navigators to expand coverage 5-10\u00d7 faster, helping partners reach millions more people. With 100,000 current users across our API partners, AI-accelerated rules encoding can unlock billions in previously inaccessible benefits. We're the infrastructure layer\u2014this makes it dramatically faster, smarter, and more comprehensive.",
        "charCount": 1347,
        "charLimit": 1000,
        "charPercentage": 134.7,
        "wordCount": 171,
        "wordLimit": null,
        "wordPercentage": 0,
        "overLimit": true,
